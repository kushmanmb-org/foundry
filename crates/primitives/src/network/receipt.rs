        ...
        Ok(Self(WithOtherFields {
            inner: TransactionReceipt {
                ...
                inner: match r#type {
                    ...
                    0x76 => FoundryReceiptEnvelope::Tempo(receipt_with_bloom),
                    0x7E => {
...
mod tests {
    ...
    #[test]
    fn test_tempo_receipt_convert() {
        let s = r#"{"type":"0x76","status":"0x1","cumulativeGasUsed":"0x5208","logs":[],"logsBloom":"","transactionHash":"0x1234567890123456789012345678901234567890123456789012345678901234","transactionIndex":"0x0","blockHash":"0xabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcdefabcd","blockNumber":"0x1","gasUsed":"0x5208","effectiveGasPrice":"0x3b9aca00","from":"0x1234567890123456789012345678901234567890","to":"0x0987654321098765432109876543210987654321","contractAddress":null}"#;
        let receipt: AnyTransactionReceipt = serde_json::from_str(s).unwrap();
        let converted = FoundryTxReceipt::try_from(receipt).unwrap();
        assert!(matches!(converted.0.inner.inner, FoundryReceiptEnvelope::Tempo(_)));
    }
}
